            ...
            <table border="0">
             <tr>
                   ...
                   <td>
						<br>
						<br>
							<a href="doctor_register.php" class="login-btn">SignUp</a> &nbsp;&nbsp;
                    </td>
					
                    <td>
						<br>
						<br>
						   <a href="doctor_login.php" class="login-btn">SignIn</a> &nbsp;&nbsp;
                    </td>
                ...
                <tr>
                    <td colspan="3">
                        <p class="heading-text">Welcome to HCAS Doctor Portal</p>
                    </td>
                </tr>
