...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        echo "<script>alert('An email with instructions to reset your password has been sent to your email address. Please check your inbox.');
...
function sendTemporaryPasswordEmail($email, $tempPassword) {
    ...
    $message .= '<img src="http://localhost/Hannani%20Project/image/logo.png" alt="Hannani Clinic Logo" style="width: 100px;">';
    $message .= '</div>';
    ...
    $message .= '<p style="text-align: center; color: #333;">Please use this temporary password to login & reset your password <a href="http://localhost/Hannani%20Project/user/doctor_login.php" style="color: #ff652f; text-decoration: underline;">log in here</a></p>';
    $message .= '</div>';
    $message .= '<div style="background-color: #f4f4f4; padding: 20px; text-align: center;">';
...
<head>
	...
	<title>HCAS - DOCTOR FORGOT PASSWORD</title>
<style>
  body{
