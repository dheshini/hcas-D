...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        echo "<script>alert('An email with a temporary password has been sent to your email address. Please check your inbox and change your password in settings.php.');
